...
class Api::V1::PostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_post" do
    assert_difference('Api::V1::Post.count') do
      post api_v1_posts_url, params: { api_v1_post: { name: @api_v1_post.name, numbare: @api_v1_post.numbare } }, as: :json
    end
  ...
  test "should update api_v1_post" do
    patch api_v1_post_url(@api_v1_post), params: { api_v1_post: { name: @api_v1_post.name, numbare: @api_v1_post.numbare } }, as: :json
    assert_response 200
  end
